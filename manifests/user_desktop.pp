...
define puppet_infrastructure::user_desktop ( $myname = 'Dummy Dummier', $myhash = '', $mykey = 'dummykey', $mygrouplist = [ ], $ignorekey = false, $myppsigs = '', $myppwrapped = '' , $screenlock_timeout_minutes = 5, $screenlock_grace_minutes = 0, String $myhomemode = '', String $user_shell = '/bin/bash' ) {
