...
class network_vpn (
  ...
  $openvpn_cipher           = 'AES-256-CBC',
    ...
    # OpenVPN specific firewall rules
...
node 'vpn' {
  ...
  $my_iface = $::networking['primary']

  # TODO: move to puppet infrastructure
  class { 'network_dhcp': iface     => $my_iface }
  class { 'network_vpn' : wan_iface => $my_iface}


  include puppet_infrastructure::firewall_addon_openvpn_server
